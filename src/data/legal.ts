      ...
      sections: [
        {
          ...
          items: [
            ...
            "Correo electrónico: contacto@bemytech.io",
        ...
        },
        {
          ...
          paragraphs: [
            "Escríbenos a contacto@bemytech.io indicando tu nombre, el derecho que deseas ejercer y los hechos que motivan tu solicitud. Atenderemos consultas en un máximo de diez (10) días hábiles y reclamos en un máximo de quince (15) días hábiles, conforme a la ley.",
          ],
        },
        {
    ...
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            "We collect only the data needed to handle your request:",
          ],
          items: [
        ...
        },
        {
          ...
          paragraphs: [
            "Write to contacto@bemytech.io stating your name, the right you wish to exercise and the facts behind your request. We will answer inquiries within ten (10) business days and claims within fifteen (15) business days, as required by law.",
          ],
        },
        {
          heading: "12. Minors",
      ...
      sections: [
        {
          ...
          paragraphs: [
            "BEMYTECH es la marca de SOLUCIONES TECNOLÓGICAS BEMYTECH S.A.S., empresa de desarrollo de software a la medida con domicilio en Pereira, Risaralda, Colombia. Contacto: contacto@bemytech.io · +57 311 430 22 56.",
          ],
        },
        {
          heading: "2. Uso permitido del sitio",
          paragraphs: [
            "Te comprometes a usar el sitio de forma lícita. En particular, no está permitido:",
          ],
          items: [
        ...
        },
        {
          heading: "12. Contacto",
          paragraphs: [
            "Para cualquier consulta sobre estos términos escríbenos a contacto@bemytech.io.",
          ],
        },
      ],
    },
      ...
      sections: [
        {
          ...
          paragraphs: [
            "BEMYTECH is the brand of SOLUCIONES TECNOLÓGICAS BEMYTECH S.A.S., a custom software development company based in Pereira, Risaralda, Colombia. Contact: contacto@bemytech.io · +57 311 430 22 56.",
          ],
        },
        {
          heading: "2. Permitted use of the site",
          paragraphs: [
            "You agree to use the site lawfully. In particular, you may not:",
          ],
          items: [
        ...
        },
        {
          heading: "12. Contact",
          paragraphs: [
            "For any questions about these terms, write to contacto@bemytech.io.",
          ],
        },
      ],
    },
